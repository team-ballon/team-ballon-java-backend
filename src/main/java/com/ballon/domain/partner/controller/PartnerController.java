...
public class PartnerController {
    ...
    public ResponseEntity<PartnerResponse> partnerRegister(@RequestBody PartnerRegisterRequest  partnerRegisterRequest) {
        partnerService.partnerRegister(partnerRegisterRequest);
